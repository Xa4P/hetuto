...
if (!requireNamespace("learnr", quietly = TRUE)) {
    stop(
      "Package \"learnr\" must be installed to use this function.",
      call. = FALSE
    )
}
