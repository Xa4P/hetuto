...
Now increase the discount rate to 10% (0.1) and decrease it to 1% (0.01) in the graph above, can you explain what happens with the discount weight over time? Can you explain what it means for the discounted costs and effects?
```{r, echo = FALSE}
