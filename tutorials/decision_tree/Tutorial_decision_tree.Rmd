...
```{r calc_out_strat-hint1}
"Use the sum() function or +"
```

```{r calc_out_strat-hint2}
# Example calculation: total expected effects "watchful waiting" strategy
t_e_ww  <- sum(t_e_path_A, t_e_path_B, t_e_path_C, t_e_path_D, t_e_path_E)
```

```{r calc_out_strat-solution}
t_e_ww  <- sum(t_e_path_A, t_e_path_B, t_e_path_C, t_e_path_D, t_e_path_E) # expected effects "watchful waiting" strategy
t_c_ww  <- sum(t_c_path_A, t_c_path_B, t_c_path_C, t_c_path_D, t_c_path_E) # expected costs "watchful waiting" strategy

t_e_trt <- sum(t_e_path_F, t_e_path_G, t_e_path_H, t_e_path_I, t_e_path_J, t_e_path_K) # expected effects treatment strategy
t_c_trt <- sum(t_c_path_F, t_c_path_G, t_c_path_H, t_c_path_I, t_c_path_J, t_c_path_K) # expected costs treatment strategy
```
