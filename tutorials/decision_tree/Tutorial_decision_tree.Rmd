...
Assign the utility values to each pathway. The pathways at the beginning of the tutorial to each pathway. For your convenience, the utility values are displayed here once again.
