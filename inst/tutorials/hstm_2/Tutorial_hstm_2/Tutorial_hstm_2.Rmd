...
Please select the most adequate distribution for these parameters: `p_post_major_stroke` and `c_post_mi`. In the plots below, you can see different distribution plotted to the mean value and standard error of these parameters.  
