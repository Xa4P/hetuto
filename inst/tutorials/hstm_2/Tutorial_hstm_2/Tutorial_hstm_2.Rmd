...
- the first 100 sets of parameters are shown, these are used in the first 100 iterations of the probabilistic analysis  

**To perform the probabilistic analysis:** Determine the number of simulation you want to run (at least 1,000), determine the seed number to use, and push the button to run the probabilistic analysis. You can also modify the mean and standard error of the efficacy of aspirin and starting age of the cohort.
