...
## EQ-5D-5L
This assignment aims to get you acquainted with measuring health-related quality of life through the EQ-5D-5L. It is based on the sample version of the EQ-5D-5L that is available at https://euroqol.org/eq-5d-instruments/sample-demo/. It is composed of both a questionnaire and the visual analog scale (VAS).  
...
p("We would like to know how good or bad your health is TODAY. This scale is numbered from 0 to 100. 100 means the best health you can imagine. 0 means the worst health you can imagine. Please slide the button to indicate how your health is TODAY.")
div(
