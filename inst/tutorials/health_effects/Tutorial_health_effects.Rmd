...
**OF NOTE**: the solutions which are provided are one way to perform the calculations, you can obtain the same results using other formula's. The last 'Hint' is always the solution of the assignment. Solutions can be copied & pasted in the chunk as shown in the figures below. Once you have completed a code chunk, you can run it by clicking the 'Run code' button on the upper-right side of the chunk.  
...
### Questions
**Please copy-paste the table above with the SF-36 results in Question 1 of the Canvas quizz.**
```{r open_q_sf36_1}
...
### Question
Fill in the Canvas quizz (Question 2) how much QALY this person accrues over the 25 years. The answer will be discussed the next session or shared on Canvas.
...
tags$hr()
p(strong("Fill in the Canvas quizz (question 3) how much QALY this person accrues over the 25 years?"),
  br(),
  "The answer will be discussed the next session or shared on Canvas.")
...
### Question
Fill in the Canvas quizz (Question 3) which intervention provides the most QALYs. The answer will be discussed the next session or shared on Canvas.

## Determining utility values
This assignment aims to teach you how to use the Dutch EQ-5D-5L tariff (Versteegh et al. - 2016) to calculate utility values based on a health state description.  
Instructions: For each health state description, calculate the utility value using the tariff provided in the table. The EQ-5D codes are organised as follows: mobility (mo), self-care (sc), usual activities (ua), pain/ discomfort level (pd), anxiety/ discomfort level (ad). Provide your answer until 3 decimals. Example: sc4 means self-care level 4.  
**Remember**: Level 1 means that someone has no impairment in a dimension. For each dimension with a Level different than 1, a disutility is applied to the constant.  
...
### Question
Fill in Question 6 of the Canvas Quiz with the utility values of the following descriptions:  
1. 12423  
2. 25431  
3. 11122  
...
**EQ-5D description first health state (12423)**:  
- I have no problems in walking about,  
- I have slight problems washing or dressing myself,  
- I have severe problems doing my usual activities,  
- I have slight pain or discomfort,  
- and I am moderately anxious or depressed.  

```{r hs_value_shiny}
h3("Standard Gamble")
p("At which probability of immediate death would you be indifferent between the gamble and remaining in health state 12423 for 10 years?")
...
p(textOutput("res_sg_hs1"))
tags$hr()
h3("Time trade off")
p("How much years of life in this health state (12423) would you trade to become indifferent between a) remaining in this health state for 10 years and b) living for 10 life years minus - the amount of traded life years in perfect health?")
...
p(textOutput("res_tto_hs1"))
tags$hr()
h3("Visual analog scale")
p("How do you rate the quality of life in this health state (12423)?")
...
### Question
Fill in the utility values you have estimated using the SG, TTO and VAS for this health status in Question 5 of the Canvas Quizz.  

## Vignette
In this assignment, you will value a health state that is described as a vignette using the following techniques: Standard Gamble, Time-trade-off, and Visual Analog Scale. A vignette is a narrative description of a health state. These vignettes are used to value the quality of life of a group of individuals when these individuals may not be able to participate in their own quality of life elicitation (for example).  
**Instructions**: read the vignette and fill in the Standard Gamble, Time-trade-off, and Visual Analog Scale .  

### Neurological disorder - Cerebrovascular Accident (serious case)
...
```{r vignettes_shiny_2}
h3("Standard Gamble")
p("At which probability of immediate death would you be indifferent between the Gamble and remaining in the above-described health state for 30 years?")
helpText("Please indicate this probability using the slider")
...
p(textOutput("res_sg_v2"))
tags$hr()
h3("Time trade off")
p("How much years of life in the above-described health state would you trade to become indifferent between a) remaining in this health state for 30 years and b) living for 30 life years minus - the amount of traded life years in perfect health?")
helpText("Please indicate this number of years using the slider")
...
p(textOutput("res_tto_v2"))
tags$hr()
h3("Visual analog scale")
p("How do you rate the quality of life in the above-described health state?")
helpText("Please indicate this on the visual analog scale using the slider")
div(style = "display:inline-block",
	HTML("The best health you can imagine"),
	shinyWidgets::noUiSliderInput(
...
#### Question
Fill in the utility values you have estimated using the SG, TTO and VAS for this health status in Question 4 of the Canvas Quiz.  
