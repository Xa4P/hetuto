...
quiz(
  ...
  incorrect = "This is not the correct answer, try again! Hint: QALYs = quality of life (utility) x length of life",
  allow_retry = TRUE
  )
)
...
h4("We would like to know how good or bad your health is TODAY. This scale is numbered from 0 to 100. 100 means the best health you can imagine. 0 means the worst health you can imagine. Please slide the button to indicate how your health is TODAY. Now, look at the number you marked on the scale on the right. (In the real EQ-5D questionnaire, the slide bar is vertical, not horizontal)")
div(
