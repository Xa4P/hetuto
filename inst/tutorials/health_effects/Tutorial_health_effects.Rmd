...
### Before starting
1. Watch the video explaining the difference between trial-based and model-based economic cost-effectiveness analyses (CEA) and the first ten minutes of the video on uncertainty assessment in health economic evaluations (to do so, you probably need to open open the tutorial in your browser using the 'Open in Browser' button on the upper left side of the screen.  
...
diff_costs <- t_costs_robot - t_costs_open # difference in costs
ICER <- diff_costs / diff_qol # difference in ICER
diff_qol
diff_costs
ICER
```
